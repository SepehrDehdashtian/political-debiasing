...
class EO(tm.Metric):
    ...
    def compute(self):
        ...
        output['EO_m_max' ]     = total_max
        output['EO_m_var' ]     = np.sqrt(total_var.cpu())
        output['EO_m_avg' ]     = total_avg.cpu()
        output['EO_m_avg_max' ] = total_avg_max.cpu()
